...
st.selectbox("Preset de modelo", list(presets.keys()),
...
st.caption(f"Precio fijo: {eur_por_1k_tokens} €/1k
...
ALERTA: estás ahorrando en TI, pero el retrabajo
...
st.caption("Interpretación: los tickets que la IA no resuelve (1
-
FCR)
